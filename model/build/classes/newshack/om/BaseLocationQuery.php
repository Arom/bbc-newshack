 ...
 * @method LocationQuery orderByArea($order = Criteria::ASC) Order by the area column
 * @method LocationQuery orderByUserId($order = Criteria::ASC) Order by the user_id column
 *
 * @method LocationQuery groupById() Group by the id column
 * @method LocationQuery groupByArea() Group by the area column
 * @method LocationQuery groupByUserId() Group by the user_id column
 *
 ...
 *
 * @method Location findOneByArea(string $area) Return the first Location filtered by the area column
 * @method Location findOneByUserId(int $user_id) Return the first Location filtered by the user_id column
 *
 * @method array findById(int $id) Return Location objects filtered by the id column
 * @method array findByArea(string $area) Return Location objects filtered by the area column
 * @method array findByUserId(int $user_id) Return Location objects filtered by the user_id column
 *
...
abstract class BaseLocationQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT [id], [area], [user_id] FROM [location] WHERE [id] = :p0';
        try {
    ...
    public function filterByArea($area = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(LocationPeer::AREA, $area, $comparison);
    }
    ...
    public function filterByUserId($userId = null, $comparison = null)
    {
        if (is_array($userId)) {
            $useMinMax = false;
            if (isset($userId['min'])) {
                $this->addUsingAlias(LocationPeer::USER_ID, $userId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userId['max'])) {
                $this->addUsingAlias(LocationPeer::USER_ID, $userId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(LocationPeer::USER_ID, $userId, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(LocationPeer::USER_ID, $user->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(LocationPeer::USER_ID, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
