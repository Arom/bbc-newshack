...
abstract class BaseLocation extends BaseObject implements Persistent
{
    ...
    public function setArea($v)
    {
        ...
        if ($this->area !== $v) {
            $this->area = $v;
            $this->modifiedColumns[] = LocationPeer::AREA;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = LocationPeer::USER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = LocationPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LocationPeer::AREA)) {
            $modifiedColumns[':p' . $index++]  = '[area]';
        }
        if ($this->isColumnModified(LocationPeer::USER_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LocationPeer::AREA)) $criteria->add(LocationPeer::AREA, $this->area);
        if ($this->isColumnModified(LocationPeer::USER_ID)) $criteria->add(LocationPeer::USER_ID, $this->user_id);
