...
abstract class BaseLocationPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Area', 'UserId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'area', 'userId', ),
        BasePeer::TYPE_COLNAME => array (LocationPeer::ID, LocationPeer::AREA, LocationPeer::USER_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'AREA', 'USER_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'area', 'user_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Area' => 1, 'UserId' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'area' => 1, 'userId' => 2, ),
        BasePeer::TYPE_COLNAME => array (LocationPeer::ID => 0, LocationPeer::AREA => 1, LocationPeer::USER_ID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'AREA' => 1, 'USER_ID' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'area' => 1, 'user_id' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LocationPeer::AREA);
            $criteria->addSelectColumn(LocationPeer::USER_ID);
        } else {
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(LocationPeer::USER_ID, UserPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Location objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Location) to $obj2 (User)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Location) to the collection in $obj2 (User)
                $obj2->addLocation($obj1);
